...
class CreateTaxonRelationshipComponentsTable extends Migration
{
    use MigrationTrait;

    protected $tableName = 'taxon_relationship_components';
    ...
    public function up()
    {
        ...
        Schema::table('taxon_relationships', function (Blueprint $table) {
            $table->foreign('taxon_relationship_component_id')->on($this->tableName)->references('id');
        });
    }
    ...
    {
        Schema::table('taxon_relationships', function (Blueprint $table) {
            $table->dropForeign('taxon_relationships_taxon_relationship_component_id_foreign');
        });
