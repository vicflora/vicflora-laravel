...
class CreateDegreeOfEstablishmentsTable extends Migration
{
    use MigrationTrait;

    protected $tableName = 'degree_of_establishment';
    ...
    public function up()
    {
        ...
        Schema::table('taxon_concepts', function (Blueprint $table) {
            $table->foreign('degree_of_establishment_id')->on($this->tableName)->references('id');
        });
    }
    ...
    {
        Schema::table('taxon_concepts', function (Blueprint $table) {
            $table->dropForeign('taxon_concepts_degree_of_establishment_id_foreign');
        });
